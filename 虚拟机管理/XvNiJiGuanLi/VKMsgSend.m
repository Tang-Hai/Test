    ...
    for (NSUInteger i = 2; i< [methodSignature numberOfArguments]; i++) {
        ...
        switch (argumentType[0]=='r'?argumentType[1]:argumentType[0]) {
            ...
            break; \
                            ...
                            vk_CALL_ARG_STRUCT(NSRect, rectValue)
                            vk_CALL_ARG_STRUCT(NSPoint, pointValue)
                            vk_CALL_ARG_STRUCT(NSSize, sizeValue)
                            vk_CALL_ARG_STRUCT(NSRange, rangeValue)
                            vk_CALL_ARG_STRUCT(CATransform3D,CATransform3DValue )
                            vk_CALL_ARG_STRUCT(NSEdgeInsets, edgeInsetsValue)
        ...
        if (strncmp(returnType, "@", 1) == 0) {
            ...
            break; \
                ...
                return returnValue;\
                                    ...
                                    vk_CALL_RET_STRUCT(NSRect)
                                    vk_CALL_RET_STRUCT(NSPoint)
                                    vk_CALL_RET_STRUCT(NSSize)
                                    vk_CALL_RET_STRUCT(NSRange)
                                    vk_CALL_RET_STRUCT(CGAffineTransform)
                                    vk_CALL_RET_STRUCT(CATransform3D)
                }
                    break;
                case '*':{
    ...
    for (NSUInteger i = 2; i < [methodSignature numberOfArguments]; i++) {
        ...
        break; \
            ...
            break; \
                ...
                vk_FWD_ARG_STRUCT(NSRect, valueWithRect)
                vk_FWD_ARG_STRUCT(NSPoint, valueWithPoint)
                vk_FWD_ARG_STRUCT(NSSize, valueWithSize)
                vk_FWD_ARG_STRUCT(NSRange, valueWithRange)
                vk_FWD_ARG_STRUCT(CATransform3D,valueWithCATransform3D)
                vk_FWD_ARG_STRUCT(NSEdgeInsets, valueWithEdgeInsets)
            }
                break;
            case '*':{
...
-(id)VKCallSlefSelectorName:(NSString *)selName error:(NSError *__autoreleasing *)error, ...
{
    SEL selector = NSSelectorFromString(selName);
